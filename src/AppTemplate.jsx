...
const PROMPTS = [
  { id: "01", title: "What Do I Actually Want", body: `I'm going to describe my situation and what I think I want. Your job is not to validate me. Your job is to ask me questions until we get to what I actually want — not what sounds good, not what I think I should want, not what would impress people. Keep pushing until we hit something specific enough that I could take action on it tomorrow.\n\nHere's where I'm at:\n\n[Describe your situation — what's going on in your life, what you think you want, and why you're unsure]` },
  { id: "02", title: "What Am I Avoiding and Why", body: `I'm going to tell you about a goal I have and what I've been doing (or not doing) about it. I want you to tell me — directly — what it looks like I'm avoiding and why. I'm not here for comfort. I'm here because I keep circling the same spot and I need someone to call it out.\n\nHere's the goal and what I've actually been doing:\n\n[Your goal + honest account of your actions (or inaction)]` },
  { id: "03", title: "Turn My Idea Into a First Step", body: `I have an idea but I keep thinking about it instead of doing anything. I need you to take what I describe and give me ONE single action I can complete today — not a plan, not a roadmap, not "research more." One concrete thing that moves this forward by tonight.\n\nThe idea:\n\n[Describe your idea — even if it's half-formed, write it out]` },
  { id: "04", title: "What Would I Do If I Couldn't Fail", body: `I'm going to tell you what I'd do with my life if failure wasn't possible. Then I need you to reverse engineer it. Break it down into what the first year would look like, what the first month would look like, and what I should be doing this week. Don't water it down. Treat it like a real plan.\n\nIf I couldn't fail:\n\n[Describe the life, career, or project you'd build if success was guaranteed]` },
  { id: "05", title: "Audit My Last Week", body: `I'm going to tell you how I spent my time this past week — honestly. I want you to compare it against what I say matters to me and show me the gap. No judgment, just the truth. Where did my time actually go versus where I said it would?\n\nWhat matters to me:\n\nHow I actually spent my week:\n\n[List what you say matters to you, then honestly describe how you spent your time — include the scrolling, the naps, all of it]` },
  { id: "06", title: "Call Me Out", body: `I'm going to tell you my plan. I want you to find every hole in it — the parts I'm not thinking about, the parts I'm being delusional about, the parts that won't work. Don't encourage me. Don't tell me it's a good start. Just show me where it breaks.\n\nHere's my plan:\n\n[Lay out your plan in as much detail as you can]` },
  { id: "07", title: "Build Me a 30-Day Sprint", body: `I have a goal I want to make real progress on in the next 30 days. I need you to build me a day-by-day sprint. Not a vague weekly plan — actual daily actions that are small enough to do but add up to something real by day 30.\n\nThe goal:\n\nWhere I'm starting from:\n\nHours per day I can dedicate:\n\n[Your goal, your current starting point, and how much time you have per day]` },
  { id: "08", title: "What Skill Am I Missing", body: `I'm going to describe where I am and where I want to be. I need you to identify the specific skills that are missing — not motivation, not mindset, the actual skills. Then rank them by which one would close the biggest gap fastest if I learned it right now.\n\nWhere I am:\n\nWhere I want to be:\n\n[Your current reality + your goal — be specific about both]` },
  { id: "09", title: "Rewrite My Story", body: `I'm going to tell you the story I tell myself about why I can't do what I want to do. I want you to take that same story — same facts, same history — and rewrite it as a story about why I'm exactly the right person to do this. Don't make things up. Use what I give you. Just change the framing.\n\nThe story I tell myself:\n\n[The narrative you're stuck in — the reasons you believe you can't do it]` },
  { id: "10", title: "Make Me Choose", body: `I'm stuck between two paths and I keep going back and forth instead of committing. I need you to force a decision. Ask me the questions that will make it obvious which one I should pick. Don't let me say "both" or "it depends." By the end of this conversation I need to have chosen one and killed the other.\n\nPath A:\n\nPath B:\n\n[Describe both options — what each path looks like, what you'd gain, what you'd give up]` },
  { id: "11", title: "What Would Someone I Admire Do", body: `I'm going to name someone I respect and describe a situation I'm stuck in. I want you to analyze how that person thinks and operates, then tell me what they would likely do in my exact situation. Not generic advice — specific moves based on how they actually approach problems.\n\nPerson I admire and why:\n\nMy situation:\n\n[Name someone you look up to + describe why + describe your current situation]` },
  { id: "12", title: "Blind Spot Check", body: `I'm going to describe everything I'm currently working on and how I think it's going. I want you to tell me what I'm not seeing — the obvious thing I'm missing, the risk I'm ignoring, the opportunity I'm walking past, the pattern I'm repeating. Be specific. If you don't see any blind spots, say so. But look hard.\n\nHere's everything I've got going on:\n\n[Lay out all your current projects, plans, and how you think each is going]` },
];
...
function GameBlocksView() {
  ...
  return (
    <div>
      ...
      {PROMPTS.map(p => (
        <CollapseSection key={p.id} title={`${p.id} — ${p.title}`} accent={t.accent}>
          <pre style={{ fontFamily: t.fontSans, fontSize: 12, color: t.textSub, lineHeight: 1.8, whiteSpace: "pre-wrap", wordBreak: "break-word", margin: 0, background: t.name === "clean" ? t.surfaceAlt : "rgba(0,240,255,0.02)", padding: "12px 14px", borderRadius: t.radiusSm, border: `1px solid ${t.border}` }}>{p.body}</pre>
        </CollapseSection>
      ))}
